...
const BADGE_DEFS = [
  ...
  { id: 'nine_1', name: 'Bintang Sembilan', desc: 'Menangkan 1 pertandingan 9-ball', tier: 'bronze', icon: 'star', check: (s) => s.wins9 >= 1 },
  { id: 'nine_10', name: 'Raja Sembilan', desc: 'Menangkan 10 pertandingan 9-ball', tier: 'gold', icon: 'crown', check: (s) => s.wins9 >= 10 },
  { id: 'golden', name: 'Golden Break', desc: 'Masukkan bola 9 saat break', tier: 'gold', icon: 'bolt', check: (s) => s.golden >= 1 },
